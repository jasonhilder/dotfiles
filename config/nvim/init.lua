...
-- [[ FILE MANAGEMENT ]]
---------------------------------------------------------------------------------
-- Alternative: Open in floating window instead of full buffer
local function open_superfile_float()
    local tmp_file = vim.fn.tempname()
    local cmd = string.format("spf")
    ...
    vim.api.nvim_create_autocmd("TermClose", {
        ...
        callback = function()
            ...
            if vim.fn.filereadable(tmp_file) == 1 then
                ...
                if selected_file and selected_file ~= "" and vim.fn.filereadable(selected_file) == 1 then
...
-- Command for floating version
vim.api.nvim_create_user_command("SuperfileFloat", open_superfile_float, {})
