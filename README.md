...
These dotfiles make use of tool composition through tmux integration. Programs like Neovim launch tools (file managers, git interfaces) in separate tmux windows rather than embedding them directly.
